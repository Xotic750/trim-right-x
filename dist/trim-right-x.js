...
var reRight = new RegExpCtr("[".concat(white_space_x_esm, "]+$"));
var methodizedReplace = simple_methodize_x_esm(trim_right_x_esm_EMPTY_STRING.replace);
/**
...
var trim_right_x_esm_trimEnd = function trimEnd(string) {
  return methodizedReplace(require_coercible_to_string_x_esm(string), reRight, trim_right_x_esm_EMPTY_STRING);
};
